...
class ImageProcessorApp:
    ...
    def create_generation_controls(self):
        ...
        line_length_combo = ttk.Combobox(line_length_frame, textvariable=line_length_var,
        ...
        line_width_combo = ttk.Combobox(line_width_frame, textvariable=line_width_var, values=[0.5, 1.5, 2.5],
                                        state="readonly")
        ...
        intersection_prob_scale = ttk.Scale(
            intersection_prob_frame, from_=0.1, to=1, variable=intersection_prob_var, orient="horizontal",
        ...
        noise_level_combo = ttk.Combobox(noise_level_frame, textvariable=noise_level_var, values=[0.1, 0.2, 0.3, 0.4],
                                         state="readonly")
    ...
    def create_hough_controls(self):
        ...
        threshold_combo = ttk.Combobox(threshold_frame, textvariable=threshold_var, values=[50, 80, 110, 140, 170, 200],
                                       state="readonly")
        ...
        min_line_length_combo = ttk.Combobox(min_line_length_frame, textvariable=min_line_length_var,
                                             values=[10, 50, 70, 100], state="readonly")
        ...
        max_line_gap_combo = ttk.Combobox(max_line_gap_frame, textvariable=max_line_gap_var, values=[1, 2, 5, 10],
                                          state="readonly")
